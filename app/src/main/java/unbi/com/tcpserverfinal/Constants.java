...
public class Constants {
    ...
    public static final int SEND_AUTOREM_MSG=2;
    public static final int SEND_MSG_ID=3;
    ...
    public static final String SEND_MSG_WITH_ID = "Intent.unbi.tcpSend.TCP_ID_MSG";
